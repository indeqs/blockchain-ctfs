...
contract ArcticVault {
    ...
    bool paused; // default value is false
    bool reentrancyGuard; // default value is false
    ...
    // require paused = true, reentrancyGuard = true
